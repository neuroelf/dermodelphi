...
export const TXT_AKA_NEW = 'and a.k.a. '
...
export const TXT_MODIFIABLE_BY_NEW = 'and modifiable by '
...
export const CORRECTION_DELSYNS_TXT = 'Remove synonyms'
export const CORRECTION_EDITMODS_TXT = 'Edit modifiers'
export const CORRECTION_EDITSYNS_TXT = 'Edit synonyms'
...
export const CORRECTION_NEWSYNS_TXT = 'Add synonyms'
